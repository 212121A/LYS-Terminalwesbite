          ...
          <div className="px-4 py-3 space-y-2 pb-6">
            ...
            <div className="pt-4 mt-2 border-t border-border animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <button
                ...
                onClick={onCheckout}
                className="w-full h-14 min-[1600px]:h-20 rounded-full bg-emerald-600 text-white text-[16px] min-[1600px]:text-[26px] font-semibold active:scale-[0.98] transition-all duration-150 shadow-[0_8px_22px_-6px_rgba(150,171,88,0.55)] hover:bg-emerald-700 flex items-center justify-center gap-2.5"
              >
                {tr.placeOrder}
