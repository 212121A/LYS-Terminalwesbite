...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { id: "2", number: "2", name: "Mini Frühlingsrollen (vegan) (7 Stück)", price: 2.00, dishType: "miniFruehling", allergens: ["1", "1a", "11"], additives: [] },
    ],
  },
  {
    id: "thai-curry",
    ...
    items: withCarbChoice([
      ...
      { id: "c4", number: "C4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, spicy: true, dishType: "fischGemüse", allergens: ["1", "1a", "4", "7", "15", "16"], additives: ["g"] },
  ...
  },
  {
    ...
    items: withCarbChoice([
      ...
      { id: "s4", number: "S4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, dishType: "fischGemüse", allergens: ["1", "1a", "4"], additives: ["d"] },
  ...
  },
  {
    ...
    items: withCarbChoice([
      ...
      { id: "b4", number: "B4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, dishType: "fischGemüse", allergens: ["1", "1a", "4", "6"], additives: ["a", "g"] },
  ...
  },
  {
    ...
    items: withCarbChoice([
      ...
      { id: "e4", number: "E4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, spicy: true, dishType: "fischGemüse", allergens: ["1", "1a", "4", "5", "7", "15", "16"], additives: ["g"] },
  ...
  },
  {
    ...
    items: withCarbChoice([
      ...
      { id: "m4", number: "M4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, dishType: "fischGemüse", allergens: ["1", "1a", "4", "7", "15", "16"], additives: ["e", "g"] },
  ...
  },
  {
    ...
    items: withCarbChoice([
      ...
      { id: "m11", number: "M11", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, dishType: "fischGemüse", allergens: ["1", "1a", "4", "7", "15", "16"], additives: ["g"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "a4", number: "A4", name: "Fisch mit Gemüse (Pangasius Filet)", price: 10.50, dishType: "fischGemüse", allergens: ["1", "1a", "3", "4"], additives: ["g"] },
